...
const extractionRulesRepository = new ExtractionRulesRepository(gitTransactionManager);
...
async function startServer() {
  ...
  app.use('/api', auth, routes({ tagsRepository, keysRepository, appsRepository, policyRepository, extractionRulesRepository }));
