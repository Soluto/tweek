# ![Tweek](https://soluto.github.io/docs.tweek.fm/assets/logo-with-background.png)  
...
### Getting Started
The easiest way to start evaluating Tweek is to run it locally on docker, make sure you have the latest version.
#### Running Tweek
- clone the repo
