...
target "editor" {
    ...
    tags = ["tweek-editor:ref-${GITHUB_SHA}"]
...
target "publishing" {
    ...
    tags = ["tweek-publishing:ref-${GITHUB_SHA}"]
...
target "authoring" {
    ...
    tags = ["tweek-authoring:ref-${GITHUB_SHA}"]
...
target "gateway" {
    ...
    tags = ["tweek-gateway:ref-${GITHUB_SHA}"]
