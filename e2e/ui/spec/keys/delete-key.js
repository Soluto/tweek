...
import { defaultTimeout } from '../../utils/key-utils';
...
describe('delete key', () => {
  ...
  describe('archive', () => {
    it('should archive key', () => {
      Key.open('behavior_tests/delete_key/archive').commitChanges(archiveKey);

      browser.waitForVisible(keyMessage, defaultTimeout);
      expect(Key.displayName).to.startsWith('ARCHIVED: ');
